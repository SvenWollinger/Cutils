...
object BirthdayCommand: BaseCommand, SlashCommandAdapter, CommandAutoCompleteAdapter {
    override val slashCommandLabel = "birthday"
    ...
    override fun register(): Array<CommandData> = arrayOf(
        Commands.slash(slashCommandLabel, "Manage birthday settings").also {
            it.addSubcommands(
